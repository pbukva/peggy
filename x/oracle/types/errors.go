...
func ErrProphecyNotFound(codespace sdk.CodespaceType, id string) sdk.Error {
	return sdk.NewError(codespace, CodeProphecyNotFound, fmt.Sprintf("prophecy with given id not found: %s", id))
}
